...
- 自动量化：默认Q4_K_M量化
- OpenAI兼容API：`https://ferryman1980.github.io/r/a43140.html
...
# Windows
# 下载exe安装包：https://ferryman1980.github.io/r/29f5fa.html
```
...
response = requests.post(
    "https://ferryman1980.github.io/r/6890fb.html",
    json={
        "model": "llama3.1",
...
- **问题1：** 首次运行模型时，Ollama会下载整个模型文件（4-8GB），国内网络极慢。
  - **解决：** 使用代理或从Hugging Face镜像站下载：`export HF_ENDPOINT=https://ferryman1980.github.io/r/c393ce.html
- **问题2：** 多模型切换时，显存不会自动释放。
...
**编译安装：**
```bash
git clone https://ferryman1980.github.io/r/2e19cf.html
cd llama.cpp
...
# 或从源码安装（推荐）
git clone https://ferryman1980.github.io/r/d5a31b.html
cd vllm
pip install -e .
```
...
client = OpenAI(
    base_url="https://ferryman1980.github.io/r/110a4f.html
...
- **问题1：** 首次启动需要下载模型权重，Hugging Face被墙。
  - **解决：** 设置环境变量：`export HF_ENDPOINT=https://ferryman1980.github.io/r/c393ce.html
...
**API调用：**
```bash
curl https://ferryman1980.github.io/r/55434e.html \
...
```bash
# 直接从官网下载
# https://ferryman1980.github.io/r/0799be.html
...
```bash
# 使用Hugging Face镜像
export HF_ENDPOINT=https://ferryman1980.github.io/r/68494c.html
export HF_HUB_ENABLE_HF_TRANSFER=1

# 使用国内镜像站
export HF_ENDPOINT=https://ferryman1980.github.io/r/68494c.html
# 或
export HF_ENDPOINT=https://ferryman1980.github.io/r/1ae68d.html
```
...
2. 限制API访问：`export OLLAMA_ORIGINS=https://ferryman1980.github.io/r/4c8fbc.html
...
services:
        ...
        reservations:
          devices:
            - driver: nvidia
              ...
              capabilities: [gpu]
    healthcheck:
      test: ["CMD", "curl", "-f", "https://ferryman1980.github.io/r/af49b0.html]
      interval: 30s
      timeout: 10s
      retries: 3
  ...
  open-webui:
    ...
    environment:
      - OLLAMA_BASE_URL=https://ferryman1980.github.io/r/b5fd8f.html
...
# 性能基准测试
time curl -X POST https://ferryman1980.github.io/r/6890fb.html \
