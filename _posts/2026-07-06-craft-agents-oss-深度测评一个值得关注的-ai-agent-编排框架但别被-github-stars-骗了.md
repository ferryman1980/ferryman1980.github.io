...
- **craft-agents-oss 官网**: [https://github.com/craft-ai-agents/craft-agents-oss](https://github.com/craft-ai-agents/craft-agents-oss)

如果你还是想试试，建议先 fork 再改，不要直接 pip install。我踩过的坑，希望你不要再踩了。